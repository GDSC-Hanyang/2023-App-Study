...
1. `CrossAxisAlignment.start`: 교차 축의 시작 부분에 자식 위젯을 정렬합니다.
2. `CrossAxisAlignment.end`: 교차 축의 끝 부분에 자식 위젯을 정렬합니다.
3. `CrossAxisAlignment.center`: 교차 축을 중심으로 자식 위젯을 가운데 정렬합니다.
4. `CrossAxisAlignment.stretch`: 교차 축을 따라 자식 위젯을 확장하여 꽉 채웁니다. 이 옵션을 사용하면 자식 위젯이 교차 축의 길이에 맞게 확장됩니다.
